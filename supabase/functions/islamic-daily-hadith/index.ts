...
const HADITHS = [
  { id: 1, arabic: 'إِنَّمَا الأَعْمَالُ بِالنِّيَّاتِ، وَإِنَّمَا لِكُلِّ امْرِئٍ مَا نَوَى', english: 'Actions are judged by intentions, and everyone will get what was intended.', source: 'Sahih al-Bukhari' },
  { id: 2, arabic: 'الإِيمَانُ بِضْعٌ وَسِتُّونَ شُعْبَةً', english: 'Faith has over sixty branches.', source: 'Sahih al-Bukhari' },
  { id: 3, arabic: 'لَا يُؤْمِنُ أَحَدُكُمْ حَتَّى يُحِبَّ لأَخِيهِ مَا يُحِبُّ لِنَفْسِهِ', english: 'None of you truly believes until he loves for his brother what he loves for himself.', source: 'Sahih al-Bukhari' },
  { id: 4, arabic: 'الْمُسْلِمُ مَنْ سَلِمَ الْمُسْلِمُونَ مِنْ لِسَانِهِ وَيَدِهِ', english: 'A Muslim is one from whose tongue and hand other Muslims are safe.', source: 'Sahih al-Bukhari' },
  { id: 5, arabic: 'أَفْضَلُ الأَعْمَالِ الصَّلاَةُ عَلَى وَقْتِهَا', english: 'The best deed is prayer performed on time.', source: 'Sahih al-Bukhari' },
  { id: 6, arabic: 'مَنْ كَانَ يُؤْمِنُ بِاللَّهِ وَالْيَوْمِ الآخِرِ فَلْيَقُلْ خَيْرًا أَوْ لِيَصْمُتْ', english: 'Whoever believes in Allah and the Last Day should speak good or remain silent.', source: 'Sahih al-Bukhari' },
  { id: 7, arabic: 'اتَّقِ اللَّهَ حَيْثُمَا كُنْتَ', english: 'Fear Allah wherever you are.', source: 'Sunan at-Tirmidhi' },
  { id: 8, arabic: 'تَبَسُّمُكَ فِي وَجْهِ أَخِيكَ لَكَ صَدَقَةٌ', english: 'Your smile for your brother is charity.', source: 'Sahih al-Bukhari' },
  { id: 9, arabic: 'مَا نَقَصَتْ صَدَقَةٌ مِنْ مَالٍ', english: 'Charity does not decrease wealth.', source: 'Sahih al-Bukhari' },
...
Deno.serve(async () => {
  try {
    ...
    const { data: users, error: usersErr } = await admin
      ...
      .select('user_id, daily_hadith_time, hadith_source_preference, notification_language, timezone')
    ...
    if (!users || users.length === 0) {
      return new Response(JSON.stringify({ message: 'No users with daily hadith enabled' }), { status: 200 });
    }
