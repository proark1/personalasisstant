...
const REMINDER_SCHEDULES: ReminderSchedule[] = [
  {
    ...
    body: "3 months until renewal",
  },
  {
    daysBeforeDeadline: 30,
    priority: "medium",
    title: "Contract Renewal Reminder",
    body: "1 month until renewal",
  },
  {
    daysBeforeDeadline: 14,
    priority: "high",
    title: "Contract Deadline Approaching",
    body: "2 weeks until deadline",
  },
  {
    daysBeforeDeadline: 7,
    priority: "critical",
    title: "Urgent: Contract Action Required",
    body: "1 week until deadline",
  },
  {
    daysBeforeDeadline: 3,
    priority: "critical",
    title: "Critical: Contract Action Required",
    body: "3 days until deadline",
  },
  {
    daysBeforeDeadline: 1,
    priority: "critical",
    title: "Final Notice: Contract Action Tomorrow",
