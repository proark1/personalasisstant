...
export function PropertyPanel() {
  ...
  const handleToggleMaintenanceStatus = async (task: PropertyMaintenance) => {
    ...
    await updateMaintenance(task.id, {
      status: newStatus,
      completed_date:
        newStatus === "completed" ? new Date().toISOString().split("T")[0] : undefined,
    });
  };
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => setPropertyForm({ ...propertyForm, current_value: e.target.value })}
          />
        </div>
      </div>
      <div className="space-y-2">
  ...
  const addButton = (
    <Dialog
      ...
      onOpenChange={(v) => {
        setShowAddDialog(v);
        if (v) setPropertyForm(emptyPropertyForm);
      }}
    >
      ...
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleAddProperty} disabled={!propertyForm.name.trim()}>
            Add Property
          </Button>
        </DialogFooter>
      </DialogContent>
            ...
            <Tabs defaultValue="overview" className="flex-1 flex flex-col">
              ...
              <TabsContent value="overview" className="flex-1 mt-0">
                <ScrollArea className="h-full">
                  ...
                  >
                      ...
                      <GlassCard className="p-4">
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <div className="flex gap-1">
                            <Button size="icon" variant="ghost" onClick={openEditDialog}>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    This will permanently delete "{selectedPropertyData.name}" and
                                    all associated data.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          <div>
                            ...
                            <span className="capitalize">{selectedPropertyData.property_type}</span>
                          </div>
                          {selectedPropertyData.city && (
                            <div>
                              <span className="text-muted-foreground">Location:</span>{" "}
                              {[selectedPropertyData.city, selectedPropertyData.country]
                                .filter(Boolean)
                                .join(", ")}
                            </div>
                          )}
                          ...
                          {selectedPropertyData.purchase_date && (
                            <div>
                              <span className="text-muted-foreground">Purchased:</span>{" "}
                              {format(new Date(selectedPropertyData.purchase_date), "MMM yyyy")}
                            </div>
                          )}
                        </div>
                    ...
                    {/* Value card */}
                    {(selectedPropertyData.purchase_price ||
                      selectedPropertyData.current_value) && (
                      <motion.div variants={staggerItem}>
                        <GlassCard className="p-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            {selectedPropertyData.purchase_price != null && (
                              <div>
                                ...
                                <p className="text-lg font-semibold">
                                  {formatCurrency(selectedPropertyData.purchase_price)}
                                </p>
                              </div>
                            )}
                            {selectedPropertyData.current_value != null && (
                              <div>
                                ...
                                <p className="text-lg font-semibold">
                                  {formatCurrency(selectedPropertyData.current_value)}
                                </p>
                              </div>
                            )}
                          </div>
                          {valueChange != null && (
                            ...
                            >
                              ...
                              {((valueChange / selectedPropertyData.purchase_price!) * 100).toFixed(
                                1,
                              )}
                              %)
                            </div>
                  ...
                  <div className="p-3 sm:p-4">
                    <div className="flex justify-end mb-3">
                      <Dialog
                        ...
                        onOpenChange={(v) => {
                          setShowMaintenanceDialog(v);
                          if (v) setMaintenanceForm(emptyMaintenanceForm);
                        }}
                      >
                        <DialogTrigger asChild>
                          <Button size="sm">
                        ...
                        <DialogContent>
                          ...
                          <div className="space-y-4 py-2">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <div className="space-y-2">
                                ...
                                <Select
                                  ...
                                  onValueChange={(v) =>
                                    setMaintenanceForm({ ...maintenanceForm, category: v })
                                  }
                                >
                                  <SelectTrigger>
                                    <SelectValue />
                            ...
                            <div className="flex items-center gap-2">
                              <Checkbox
                                checked={maintenanceForm.is_recurring}
                                onCheckedChange={(v) =>
                                  setMaintenanceForm({ ...maintenanceForm, is_recurring: !!v })
                                }
                              />
                          ...
                          <DialogFooter>
                            ...
                            <Button
                              ...
                              disabled={!maintenanceForm.title.trim()}
                            >
                              Add Task
                            </Button>
                          </DialogFooter>
                    ...
                    {propertyMaintenance.length === 0 ? (
                      <EmptyState
                        ...
                        description="Track repairs, inspections, and upkeep"
                      />
                    ) : (
                      <motion.div
                        className="space-y-2"
                        ...
                        {propertyMaintenance.map((task) => (
                          <motion.div key={task.id} variants={staggerItem}>
                            <GlassCard
                              ...
                              onClick={() => handleToggleMaintenanceStatus(task)}
                            >
                  ...
                  <div className="p-3 sm:p-4">
                    <div className="flex justify-end mb-3">
                      <Dialog
                        ...
                        onOpenChange={(v) => {
                          setShowChecklistDialog(v);
                          if (v) setChecklistForm(emptyChecklistForm);
                        }}
                      >
                        <DialogTrigger asChild>
                          <Button size="sm">
                          ...
                          <div className="space-y-4 py-2">
                            ...
                            <div className="space-y-2">
                              ...
                              <Select
                                ...
                                onValueChange={(v) =>
                                  setChecklistForm({ ...checklistForm, checklist_type: v })
                                }
                              >
                                <SelectTrigger>
                                  <SelectValue />
                    ...
                    {propertyChecklists.length === 0 ? (
                      <EmptyState
                        icon={CheckSquare}
                        title="No checklists"
                        description="Create checklists for inspections, move-ins, and more"
                      />
                    ) : (
                      <motion.div
                        className="space-y-4"
              ...
              <TabsContent value="documents" className="flex-1 mt-0">
                <EmptyState
                  ...
                  description="Coming soon — store deeds, contracts, and receipts"
                />
              </TabsContent>
            </Tabs>
          ) : (
      ...
      <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleEditProperty} disabled={!propertyForm.name.trim()}>
              Save Changes
            </Button>
          </DialogFooter>
        </DialogContent>
