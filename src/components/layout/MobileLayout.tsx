...
const TeamChatPanel = lazy(() =>
  import("../chat/TeamChatPanel").then((m) => ({ default: m.TeamChatPanel })),
);
const CalendarHubPanel = lazy(() =>
  import("../calendar/CalendarHubPanel").then((m) => ({ default: m.CalendarHubPanel })),
);
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  "active:scale-90",
                  isActive ? "text-primary" : !tab.isCenter ? "text-muted-foreground" : "",
                )}
              >
                {tab.isCenter ? (
