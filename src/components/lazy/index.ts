...
export const LazyBudgetTrackingPanel = lazy(() =>
  import("@/components/family/BudgetTrackingPanel").then((m) => ({
    default: m.BudgetTrackingPanel,
  })),
);
export const LazyHealthTrackingPanel = lazy(() =>
  import("@/components/family/HealthTrackingPanel").then((m) => ({
    default: m.HealthTrackingPanel,
  })),
);
export const LazyDocumentStoragePanel = lazy(() =>
  import("@/components/family/DocumentStoragePanel").then((m) => ({
    default: m.DocumentStoragePanel,
  })),
);
...
export const LazyWeeklyInsightsPanel = lazy(() =>
  import("@/components/insights/WeeklyInsightsPanel").then((m) => ({
    default: m.WeeklyInsightsPanel,
  })),
);
export const LazyLifePatternsDashboard = lazy(() =>
  import("@/components/insights/LifePatternsDashboard").then((m) => ({
    default: m.LifePatternsDashboard,
  })),
);

// Admin feature
export const LazyAdminAnalyticsPanel = lazy(() =>
  import("@/components/admin/AdminAnalyticsPanel").then((m) => ({
    default: m.AdminAnalyticsPanel,
  })),
);
...
export const LazyLocationRemindersPanel = lazy(() =>
  import("@/components/location/LocationRemindersPanel").then((m) => ({
    default: m.LocationRemindersPanel,
  })),
);
