      ...
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-2 flex-wrap">
            {/* Priority */}
            <div
              className={cn("flex items-center gap-1 px-1.5 py-0.5 rounded text-xs", priority.bg)}
            >
  ...
  return (
    <div className="h-full flex flex-col">
          ...
          {(["all", "high", "medium", "low"] as const).map((p) => (
            <Button
              ...
              className={cn(
                ...
                priorityFilter === p && "bg-background shadow-sm",
              )}
      ...
      >
          ...
          {columns.map((column) => {
            ...
            return (
              <div key={column.id} className="flex-1 min-w-[280px] max-w-[400px] flex flex-col">
                <div className={cn("flex items-center gap-2 px-3 py-2 rounded-t-lg", column.color)}>
        ...
        <DragOverlay>
          {activeTask ? <TaskCardOverlay task={activeTask} projects={projects} /> : null}
        </DragOverlay>
      </DndContext>
    </div>
  );
