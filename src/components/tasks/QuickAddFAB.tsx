            ...
            <form onSubmit={handleSubmit}>
              ...
              {parsedTask && parsedTask.title && (
                <div className="text-xs space-y-1.5 mb-3 p-2 bg-muted/50 rounded-lg">
                  <div className="font-medium text-foreground truncate">{parsedTask.title}</div>
                  <div className="flex items-center gap-3 text-muted-foreground flex-wrap">
                    ...
                    <span
                      className={cn("flex items-center gap-1", priorityColors[parsedTask.priority])}
                    >
              ...
              <div className="flex items-center justify-between">
                <span className="text-[10px] text-muted-foreground">⌘⇧A to open</span>
                <Button type="submit" size="sm" disabled={!parsedTask?.title}>
                  Add Task
                </Button>
              </div>
            </form>
