...
import { Newspaper, Bookmark, ExternalLink, RefreshCw, Check } from 'lucide-react';
            ...
            <div className="p-4 space-y-3">
              {newsLoading ? (
                ...
                liveNews.map((article, idx) => (
                  <GlassCard key={idx} className="p-4 hover:border-primary/50 transition-all">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex flex-col gap-1">
                        <Button variant="ghost" size="icon" onClick={() => saveArticle(article)}>
                          <Bookmark className="w-4 h-4" />
                        </Button>
                        {article.url && (
                          <Button variant="ghost" size="icon" onClick={() => window.open(article.url, '_blank')}>
                ...
                savedArticles.map((article) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex flex-col gap-1">
                        {!article.is_read && (
                          <Button variant="ghost" size="icon" onClick={() => markAsRead(article.id)}>
