              ...
              {categories.map((cat) => (
                <Badge
                  ...
                  className={cn(
                    ...
                    selectedCategory !== cat && getCategoryStyle(cat),
                  )}
                ...
                <EmptyState
                  ...
                  description={
                    search || selectedCategory
                      ...
                      : "Pull to refresh or check your topic preferences"
                  }
                  action={
                    search || selectedCategory ? (
                      <Button
                ...
                <EmptyState
                  ...
                  description={
                    savedFilter !== "all" || search
                      ...
                      : "Bookmark articles from the Live Feed to read later"
                  }
                  action={
                    savedFilter !== "all" ? (
                      <Button variant="outline" size="sm" onClick={() => setSavedFilter("all")}>
                        Show All
                      </Button>
                    ) : undefined
                  }
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                            <Badge
                              ...
                              className={cn(
                                "text-[10px] px-1.5 py-0",
                                getCategoryStyle(article.category || "Tech"),
                              )}
                            >
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex gap-2">
                ...
                />
                <Button variant="outline" size="sm" onClick={addTopic} disabled={!newTopic.trim()}>
                  Add
                </Button>
              </div>
            </div>
