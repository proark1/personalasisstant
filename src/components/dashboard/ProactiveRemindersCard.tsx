...
import { Brain, Bell, X, Clock, Check, FileText, Calendar, Users, Zap } from "lucide-react";
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-muted-foreground line-clamp-2 mt-0.5">{reminder.message}</p>
