          ...
          >
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <div className={cn(
                ...
                focusItem.priority === 'medium' ? 'bg-warning' : 'bg-muted-foreground'
              )} />
            </div>
            ...
            <div className="flex items-center gap-2 mt-4">
              <Button size="sm" className="gap-2" onClick={() => handleComplete(focusItem.id)} disabled={!!completing}>
                <CheckCircle2 className="w-4 h-4" /> Mark Done
              </Button>
              <span className={cn("text-xs px-2.5 py-1 rounded-full capitalize", "bg-muted text-muted-foreground")}>
                {focusItem.category}
              </span>
            </div>
          </motion.div>
