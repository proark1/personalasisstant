...
const HADITH_COLLECTION: Hadith[] = [
  ...
  // Sahih Bukhari - Prayer
  {
    ...
    english:
      "If there was a river at your door and you bathed in it five times a day, would any dirt remain on you?",
  },
  {
    id: 6,
    collection: "Bukhari",
  ...
  // More Bukhari
  {
    ...
    english:
      "The merciful will be shown mercy by the Most Merciful. Be merciful to those on earth, and the One in heaven will be merciful to you.",
  },
  {
    id: 26,
    collection: "Bukhari",
    ...
    grade: "Sahih",
    arabic:
      "أَحَبُّ الأَعْمَالِ إِلَى اللَّهِ الصَّلاَةُ عَلَى وَقْتِهَا ثُمَّ بِرُّ الْوَالِدَيْنِ",
    english:
      "The most beloved deeds to Allah are prayer at its proper time, then kindness to parents.",
  },
  {
    id: 27,
    collection: "Bukhari",
  ...
  const filteredHadiths = useMemo(() => {
    return HADITH_COLLECTION.filter((hadith) => {
      ...
      const matchesCollection =
        selectedCollection === "All" || hadith.collection === selectedCollection;
