  ...
  return (
    <div
      ...
      className={cn(
        ...
        isOver ? "ring-2 ring-primary bg-primary/10 scale-[1.02]" : "bg-muted/40 hover:bg-muted/60",
      )}
    >
...
function DayColumn({ day, meals, onDelete, onAddMeal }: DayColumnProps) {
  ...
  return (
    ...
    >
      {/* Day Header */}
      <div
        className={cn("px-3 py-2 text-center border-b", isToday ? "bg-primary/10" : "bg-muted/30")}
      >
...
export function MealPlanningPanel() {
  ...
  const handleGenerateShoppingList = async () => {
    ...
    const list = await addList({
      ...
      description:
        language === "de"
          ? "Automatisch aus Mahlzeitenplan erstellt"
              ...
              <div className="text-center">
                ...
                <div className="flex items-center justify-center gap-2 mt-1">
                  <Badge variant="secondary" className="text-xs">
                    {totalMealsThisWeek}{" "}
                    {totalMealsThisWeek !== 1 ? t("meals.mealsPlanned") : t("meals.mealPlanned")}
                  </Badge>
                </div>
              </div>
              <Button
                ...
                {activeDragMeal && (
                  ...
                  >
                    <div className="flex items-center gap-2 text-sm font-medium">
                      ...
                      <span>
                        {activeDragMeal.recipe?.name ||
                          activeDragMeal.custom_meal_name ||
                          "Unnamed"}
                      </span>
                    </div>
                  </div>
