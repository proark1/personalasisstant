      ...
      <DialogContent className="max-w-lg">
        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <Input value={loves} onChange={e => setLoves(e.target.value)} placeholder="pasta, apples, chicken" />
          </div>
          <div className="space-y-2">
            <Label>Dislikes</Label>
            <Input value={dislikes} onChange={e => setDislikes(e.target.value)} placeholder="mushrooms, fish" />
          </div>
          <div className="space-y-2">
            <Label>Dietary restrictions</Label>
            <Input value={diet} onChange={e => setDiet(e.target.value)} placeholder="halal, lactose-free" />
          </div>
          <div className="space-y-2">
            <Label>Favorite meals</Label>
            <Input value={favorites} onChange={e => setFavorites(e.target.value)} placeholder="biryani, pizza" />
          </div>
          <div className="space-y-2">
            <Label>Notes</Label>
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={!memberId}>Save</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
