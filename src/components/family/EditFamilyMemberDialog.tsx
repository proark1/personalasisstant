...
export function EditFamilyMemberDialog({ member, open, onOpenChange }: EditFamilyMemberDialogProps) {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="school" disabled={!isChild}>School</TabsTrigger>
