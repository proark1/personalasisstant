...
import { Shield, ShieldAlert, ChevronRight, Archive, Star } from 'lucide-react';
...
export function EmailCard({ thread, onSelect, onArchive, onToggleImportant }: EmailCardProps) {
  ...
  }, [email.id, onArchive, onToggleImportant]);
