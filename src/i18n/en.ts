...
const en: Record<string, string> = {
  ...
  'family.homework.questionPlaceholder': 'Type or paste the homework question here... Be as specific as possible!',
  ...
  'family.parenting.questionPlaceholder': "Share what's on your mind... The more context you provide, the better advice I can give.",
  'family.parenting.gettingAdvice': 'Getting advice...',
  'family.parenting.getAdvice': 'Get Advice',
  'family.parenting.disclaimer': 'This is AI-generated advice for general guidance only. For serious concerns, please consult a pediatrician or child psychologist.',
  ...
  'content.emptyBody': "No ideas yet. Generate your first batch — we'll search the web for what's happening now plus evergreen angles in your niche.",
  'content.todayBatch': "Today's batch",
  'content.latestBatch': 'Latest batch',
  'content.ideaWord': 'idea',
  'content.ideasWord': 'ideas',
  'content.likedEmpty': "Like an idea or hit Write scripts and it'll land here, ready to turn into short- and long-form scripts.",
  ...
  'content.scheduleNote': 'Creates a real event in your Calendar (and syncs to connected calendars).',
  'content.pickValidDate': 'Pick a valid date and time',
  'content.scripts': 'Scripts',
  'content.scriptsDesc': 'Short-form (TikTok / Reels / Shorts) and long-form (YouTube) scripts in your voice.',
  'content.scriptsEmpty': 'Generate scripts for this idea, written in your voice and tuned to each platform.',
  ...
  'content.calendarEmptyPost': " on an idea to drop it here — it'll also show up in your main Calendar.",
  'content.calendarNote': 'These are real calendar events — find them in your Calendar and on any connected Google/Apple calendar.',
  'content.profile.title': 'Your creator profile',
  'content.profile.desc': 'This is the brain behind your daily ideas. The more specific, the better the ideas.',
  ...
  'content.telegramNote': 'Telegram delivery requires your account to be linked in Settings → Telegram.',
  ...
  'content.toast.migrationMissing': 'Content Studio isn’t set up on the server yet — the database migration needs to be applied.',
