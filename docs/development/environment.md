...
ONEBRAIN_WORK_CORRESPONDENCE_SPACE_ID=<set once OneBrain provisions the tier space; empty disables routing>
ONEBRAIN_ASSISTANT_PRIVATE_SPACE_ID=<set once OneBrain provisions the tier space; empty disables routing>
AUTH_SESSION_TTL_SECONDS=14400
...
ONEBRAIN_SPACE_ID=<space id>
ONEBRAIN_TIMEOUT_SECONDS=10
ONEBRAIN_TOMBSTONE_POLL_SECONDS=300
ONEBRAIN_WORK_CORRESPONDENCE_SPACE_ID=<same as assistant-api>
ONEBRAIN_ASSISTANT_PRIVATE_SPACE_ID=<same as assistant-api>
